...
{ 
    char word[30] = "sea";
    //scanf("%s",word);
    char text[1024] = "A sailor went to sea, sea, sea To see what he could see, see, see But all that he could see, see, see Was the bottom of the deep blue sea, sea, sea!~";
    //scanf("%[^~]s",text);
